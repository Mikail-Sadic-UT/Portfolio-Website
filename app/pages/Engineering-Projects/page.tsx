    ...
    <main>
      ...
      <div className={styles.title}>
       ...
       <h2 className={styles.projName}>Microcontroller Game | Apr 2024</h2>
        ...
        It is entirely written in C, consisting of 1,800+ lines of code, including custom driver implementation. There was also extensive player testing to fine-tune 
        ...
        <p className={styles.projText}>The project currently has multiple aspects fully working and/or at a proof of concept stage. We are expected to finish sometime 2025.</p>
        <p className={styles.ghubText}>Github:{" "}
